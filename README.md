...
Клонируем проект на ПК при помощи git clone https://github.com/ConstCK/SkillFactory-D16.git

Открываем директорию в IDE (рекомендуется при помощи PyCharm).
...
В корневом каталоге создаем файл .env и прописываем в нем SEKRET_KEY = Сгенерированный ключ, MY_EMAIL= Ваш email, GOOGLE_USER= Google аккаунт, GOOGLE_PWD= Пароль к Google аккаунту.
